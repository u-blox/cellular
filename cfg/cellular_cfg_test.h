...
#ifndef CELLULAR_CFG_TEST_MQTT_USERNAME
/** User name to use for the MQTT test server.
 */
# define CELLULAR_CFG_TEST_MQTT_USERNAME  NULL
#endif

#ifndef CELLULAR_CFG_TEST_MQTT_PASSWORD
/** Password to use for the MQTT test server.
 */
# define CELLULAR_CFG_TEST_MQTT_PASSWORD  NULL
#endif
