# Introduction
This directory contains the porting layer implementation and build infrastructure for the Espressif ESP32 platform.  It is built upon ESP-IDF v3.3.1 (rather than v4) in order to allow it to also be built inside  AWS's device-side software.
