...
/* ----------------------------------------------------------------
 * COMPILE-TIME MACROS FOR NRF52840: TIMERS/COUNTERS
 * -------------------------------------------------------------- */
...
/** It is a design constraint of the NRF52840 UART that,
 ...
 */
#ifndef CELLULAR_PORT_UART_COUNTER_INSTANCE_0
# define CELLULAR_PORT_UART_COUNTER_INSTANCE_0   2
#endif
 ...
 */
#ifndef CELLULAR_PORT_UART_COUNTER_INSTANCE_1
# define CELLULAR_PORT_UART_COUNTER_INSTANCE_1   3
#endif
